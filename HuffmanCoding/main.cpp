...
//  HuffmanCoding
//
//  Created by Marcos Martinez on 4/13/20.
...
void swapMinHeapNode(struct MinHeapNode** y,struct MinHeapNode** x){
    struct MinHeapNode* temp = *y;
    *y = *x;
    *x = temp;
}
...
struct MinHeapNode* extractMin(struct MinHeap* minHeap){
    ...
    struct MinHeapNode* t = minHeap->array[0];
    minHeap->array[0]
...
int main()
{
    ...
    char arr[] = { 'M', 'a', 'r', 'c', 'o', 's' };
    int freq[] = { 7, 9, 11, 13, 15, 17 };
